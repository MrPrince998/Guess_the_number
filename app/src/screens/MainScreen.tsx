    ...
    >
      ...
      <View style={styles.menuContainer}>
        {menuItems.map((item, index) => (
          ...
          >
            <TouchableOpacity onPress={item.onPress} style={styles.menuButton}>
              <LinearGradient
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={{ color: "#ccc", fontSize: 16, marginBottom: 20 }}>
          Creating a new multiplayer game will generate a unique 4-character
          code. Share this code with your friends so they can join your game
          session. Once everyone has joined, you can start the game and enjoy
